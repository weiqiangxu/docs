...
flowchart TD
    ...
    subgraph "组件安装阶段"
        G[安装containerd] --> H[安装kubeadm/kubelet/kubectl]
        H --> I[安装CNI插件]
    end
    
    subgraph "集群初始化阶段"
        J[kubeadm init] --> K[配置kubectl]
        K --> L[部署Flannel网络插件]
        L --> M[部署Nginx测试服务]
    end
    
    subgraph "节点加入阶段"
        N[生成Join命令] --> O[Worker节点加入集群]
    end
...
**环境要求**：CentOS 7.6 64bit 2核 2G * 2 ( 操作系统的版本至少在7.5以上 )
...
- [知乎写的很好的深入理解StatefulSet用Kubernetes编排有状态应用](https://zhuanlan.zhihu.com/p/333244616)
- [Helm 与 Operator](https://cloud.aiops.red/helm/operator.html)
- [operator-sdk](https://github.com/operator-framework/operator-sdk)
- [operatorframework](https://operatorframework.io/)
- [基于Helm的Operator快速入门](https://sdk.operatorframework.io/docs/building-operators/helm/quickstart/)
- [换马甲：十分钟 Helm 变 Operator](https://cloud.tencent.com/developer/article/1469812)